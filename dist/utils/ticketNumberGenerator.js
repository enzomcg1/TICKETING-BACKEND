...
exports.generateUniqueTicketNumber = generateUniqueTicketNumber;
...
async function generateUniqueTicketNumber() {
    ...
    for (let attempt = 0; attempt < maxAttempts; attempt++) {
        ...
        const existingTicket = await database_1.default.ticket.findUnique({
            where: { ticketNumber },
            select: { id: true }
        });
    ...
    throw new Error(`No se pudo generar un número de ticket único después de ${maxAttempts} intentos. ` +
